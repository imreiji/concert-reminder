...
- [x] Round watch — the catalogue's quiet ladders: tracked concerts holding no future deadline, surfaced for review instead of going stale unnoticed (WISHLIST #2's cheapest shape; the discovery-matcher and per-concert re-fetch shapes remain on the list)
